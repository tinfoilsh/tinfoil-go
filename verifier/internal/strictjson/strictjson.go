...
// duplicate member names rejected everywhere, valid UTF-8, no trailing data.
package strictjson
...
//
// Unmarshal closes these by running a syntactic validation pass over
...
// this file and reimplement Unmarshal as a jsontext.Decoder plus

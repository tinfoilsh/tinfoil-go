...
require (
	...
	github.com/tinfoilsh/verifier v0.0.23
)
...
// We'll need to replace any problematic dependencies
replace github.com/google/go-sev-guest => github.com/google/go-sev-guest v0.9.0
